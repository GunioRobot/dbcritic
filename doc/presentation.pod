...
=for Bash
$ dbcritic --dsn dbi:SQLite:sample/demo.db
...
=item C<DBCritic::Loader>

=item C<DBCritic::Violation>
...
=item C<DBCritic::Policy>

=item C<DBCritic::PolicyType>
...
=item in C<App::DBCritic::Policy::> namespace
...
=item instance of C<App::DBCritic::Violation>
...
(Have ideas? Pls submit on L<GitHub|http://github.com/mjgardner/dbcritic/issues> KTHX)
...
=item CPAN: L<http://search.cpan.org/dist/App-DBCritic/>

=item MetaCPAN: L<http://metacpan.org/release/App-DBCritic/>
...
=item GitHub: L<http://github.com/mjgardner/dbcritic>
